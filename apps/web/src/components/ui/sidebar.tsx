  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Khoảng dành cho rail icon — không tăng theo lúc mở rộng (sidebar mở rộng phủ lên + backdrop) */}
        <div
          className={cn(
        ...
        {state === "expanded" &&
          ...
          !isMobile && (
            <button
              ...
              className="border-0 bg-background/70 animate-in fade-in-0 fixed inset-0 z-20 hidden cursor-default p-0 backdrop-blur-[2px] md:block"
